  ...
  storiesOf("DayList", module)
    ...
    storiesOf("InterviewerListItem", module)
      ...
      storiesOf("InterviewerList", module)
        ...
        .add("Create Form", () => <Form onChange={action("setInterviewer")} interviewers={interviewers} onSave={action("onSave")} onCancel={action("onCancel")} />)
        .add("Edit Form", () => <Form onChange={action("setInterviewer")} interviewers={interviewers} name="Sasha Mahalia" value={2} onSave={action("onSave")} onCancel={action("onCancel")} />)
